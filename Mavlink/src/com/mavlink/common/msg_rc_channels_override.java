...
public class msg_rc_channels_override extends MAVLinkMessage {
    ...
    public msg_rc_channels_override(JSONObject jo) {
        ...
        this.chan13_raw = jo.optInt("chan13_raw",0);
        this.chan14_raw = jo.optInt("chan14_raw",0);
        this.chan15_raw = jo.optInt("chan15_raw",0);
        this.chan16_raw = jo.optInt("chan16_raw",0);
        this.chan17_raw = jo.optInt("chan17_raw",0);
        this.chan18_raw = jo.optInt("chan18_raw",0);
