...
public class msg_gimbal_control extends MAVLinkMessage {
    ...
    public msg_gimbal_control(JSONObject jo) {
        ...
        this.demanded_rate_x = (float)jo.optDouble("demanded_rate_x",0);
        this.demanded_rate_y = (float)jo.optDouble("demanded_rate_y",0);
        this.demanded_rate_z = (float)jo.optDouble("demanded_rate_z",0);
