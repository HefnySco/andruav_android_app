...
public class msg_deepstall extends MAVLinkMessage {
    ...
    public msg_deepstall(JSONObject jo) {
        ...
        this.landing_lat = jo.optInt("landing_lat",0);
        this.landing_lon = jo.optInt("landing_lon",0);
        this.path_lat = jo.optInt("path_lat",0);
        this.path_lon = jo.optInt("path_lon",0);
        this.arc_entry_lat = jo.optInt("arc_entry_lat",0);
        this.arc_entry_lon = jo.optInt("arc_entry_lon",0);
