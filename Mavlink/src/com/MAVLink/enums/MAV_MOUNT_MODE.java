...
public class MAV_MOUNT_MODE {
   ...
   public static final int MAV_MOUNT_MODE_WPNEXT_OFFSET = 7; /* Gimbal tracks next waypoint location with offset | */
   public static final int MAV_MOUNT_MODE_ENUM_END = 8; /*  | */
}