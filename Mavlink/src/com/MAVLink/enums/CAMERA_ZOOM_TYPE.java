...
public class CAMERA_ZOOM_TYPE {
   ...
   public static final int ZOOM_TYPE_CONTINUOUS = 1; /* Continuous normalized zoom in/out rate until stopped. Range -1..1, negative: wide, positive: narrow/tele, 0 to stop zooming. Other values should be clipped to the range. | */
   ...
   public static final int ZOOM_TYPE_HORIZONTAL_FOV = 4; /* Zoom value as horizontal field of view in degrees. | */
   public static final int CAMERA_ZOOM_TYPE_ENUM_END = 5; /*  | */
}