 ...
 */
public class msg_esc_telemetry_21_to_24 extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24 = 11042;
    public static final int MAVLINK_MSG_LENGTH = 44;
    private static final long serialVersionUID = MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24;
    ...
    public MAVLinkPacket pack() {
        ...
        packet.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24;
    ...
    /**
     * Decode a esc_telemetry_21_to_24 message into this class fields
     *
     ...
     */
    public msg_esc_telemetry_21_to_24() {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24;
    }

    /**
     * Constructor for a new message, initializes msgid and all payload variables
     */
    public msg_esc_telemetry_21_to_24( int[] voltage, int[] current, int[] totalcurrent, int[] rpm, int[] count, short[] temperature) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24;
     ...
     */
    public msg_esc_telemetry_21_to_24( int[] voltage, int[] current, int[] totalcurrent, int[] rpm, int[] count, short[] temperature, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24;
        this.sysid = sysid;
        this.compid = compid;
     ...
     *
     */
    public msg_esc_telemetry_21_to_24(MAVLinkPacket mavLinkPacket) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24 - sysid:"+sysid+" compid:"+compid+" voltage:"+voltage+" current:"+current+" totalcurrent:"+totalcurrent+" rpm:"+rpm+" count:"+count+" temperature:"+temperature+"";
    }
    ...
    @Override
    public String name() {
        return "MAVLINK_MSG_ID_ESC_TELEMETRY_21_TO_24";
    }
}
