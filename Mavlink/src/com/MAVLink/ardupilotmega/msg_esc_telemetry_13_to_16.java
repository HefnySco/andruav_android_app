 ...
 */
public class msg_esc_telemetry_13_to_16 extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_ESC_TELEMETRY_13_TO_16 = 11040;
    public static final int MAVLINK_MSG_LENGTH = 44;
    private static final long serialVersionUID = MAVLINK_MSG_ID_ESC_TELEMETRY_13_TO_16;
    ...
    public MAVLinkPacket pack() {
        ...
        packet.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_13_TO_16;
    ...
    /**
     * Decode a esc_telemetry_13_to_16 message into this class fields
     *
     ...
     */
    public msg_esc_telemetry_13_to_16() {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_13_TO_16;
    }

    /**
     * Constructor for a new message, initializes msgid and all payload variables
     */
    public msg_esc_telemetry_13_to_16( int[] voltage, int[] current, int[] totalcurrent, int[] rpm, int[] count, short[] temperature) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_13_TO_16;
     ...
     */
    public msg_esc_telemetry_13_to_16( int[] voltage, int[] current, int[] totalcurrent, int[] rpm, int[] count, short[] temperature, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_13_TO_16;
        this.sysid = sysid;
        this.compid = compid;
     ...
     *
     */
    public msg_esc_telemetry_13_to_16(MAVLinkPacket mavLinkPacket) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_13_TO_16;
    ...
    @Override
    public String name() {
        return "MAVLINK_MSG_ID_ESC_TELEMETRY_13_TO_16";
    }
}
