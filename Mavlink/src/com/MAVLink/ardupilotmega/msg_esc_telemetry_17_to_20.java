 ...
 */
public class msg_esc_telemetry_17_to_20 extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20 = 11041;
    public static final int MAVLINK_MSG_LENGTH = 44;
    private static final long serialVersionUID = MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20;
    ...
    public MAVLinkPacket pack() {
        ...
        packet.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20;
    ...
    /**
     * Decode a esc_telemetry_17_to_20 message into this class fields
     *
     ...
     */
    public msg_esc_telemetry_17_to_20() {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20;
    }

    /**
     * Constructor for a new message, initializes msgid and all payload variables
     */
    public msg_esc_telemetry_17_to_20( int[] voltage, int[] current, int[] totalcurrent, int[] rpm, int[] count, short[] temperature) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20;
     ...
     */
    public msg_esc_telemetry_17_to_20( int[] voltage, int[] current, int[] totalcurrent, int[] rpm, int[] count, short[] temperature, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20;
        this.sysid = sysid;
        this.compid = compid;
     ...
     *
     */
    public msg_esc_telemetry_17_to_20(MAVLinkPacket mavLinkPacket) {
        this.msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20 - sysid:"+sysid+" compid:"+compid+" voltage:"+voltage+" current:"+current+" totalcurrent:"+totalcurrent+" rpm:"+rpm+" count:"+count+" temperature:"+temperature+"";
    }
    ...
    @Override
    public String name() {
        return "MAVLINK_MSG_ID_ESC_TELEMETRY_17_TO_20";
    }
}
