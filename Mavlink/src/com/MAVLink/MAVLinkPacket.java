    ...
    public MAVLinkMessage unpack() {
        switch (msgid) {
                ...
                return  new msg_gopro_set_response(this);
                        case msg_nav_filter_bias.MAVLINK_MSG_ID_NAV_FILTER_BIAS:
                return  new msg_nav_filter_bias(this);
                        case msg_radio_calibration.MAVLINK_MSG_ID_RADIO_CALIBRATION:
                return  new msg_radio_calibration(this);
                        case msg_ualberta_sys_status.MAVLINK_MSG_ID_UALBERTA_SYS_STATUS:
                return  new msg_ualberta_sys_status(this);
                        case msg_command_int_stamped.MAVLINK_MSG_ID_COMMAND_INT_STAMPED:
                return  new msg_command_int_stamped(this);
                        case msg_command_long_stamped.MAVLINK_MSG_ID_COMMAND_LONG_STAMPED:
                return  new msg_command_long_stamped(this);
                ...
                return  new msg_sens_mppt(this);
                        case msg_aslctrl_data.MAVLINK_MSG_ID_ASLCTRL_DATA:
                return  new msg_aslctrl_data(this);
                        case msg_aslctrl_debug.MAVLINK_MSG_ID_ASLCTRL_DEBUG:
                return  new msg_aslctrl_debug(this);
                        case msg_asluav_status.MAVLINK_MSG_ID_ASLUAV_STATUS:
                return  new msg_asluav_status(this);
                        case msg_ekf_ext.MAVLINK_MSG_ID_EKF_EXT:
                return  new msg_ekf_ext(this);
                        case msg_asl_obctrl.MAVLINK_MSG_ID_ASL_OBCTRL:
                return  new msg_asl_obctrl(this);
                        case msg_sens_atmos.MAVLINK_MSG_ID_SENS_ATMOS:
                return  new msg_sens_atmos(this);
                        case msg_sens_batmon.MAVLINK_MSG_ID_SENS_BATMON:
                return  new msg_sens_batmon(this);
                        case msg_fw_soaring_data.MAVLINK_MSG_ID_FW_SOARING_DATA:
                return  new msg_fw_soaring_data(this);
                        case msg_sensorpod_status.MAVLINK_MSG_ID_SENSORPOD_STATUS:
                return  new msg_sensorpod_status(this);
                        case msg_sens_power_board.MAVLINK_MSG_ID_SENS_POWER_BOARD:
                return  new msg_sens_power_board(this);
                        case msg_gsm_link_status.MAVLINK_MSG_ID_GSM_LINK_STATUS:
                return  new msg_gsm_link_status(this);
                        case msg_satcom_link_status.MAVLINK_MSG_ID_SATCOM_LINK_STATUS:
                return  new msg_satcom_link_status(this);
                        case msg_sensor_airflow_angles.MAVLINK_MSG_ID_SENSOR_AIRFLOW_ANGLES:
                return  new msg_sensor_airflow_angles(this);
                ...
                return  new msg_hygrometer_sensor(this);
                        case msg_test_types.MAVLINK_MSG_ID_TEST_TYPES:
                return  new msg_test_types(this);
                        case msg_array_test_0.MAVLINK_MSG_ID_ARRAY_TEST_0:
                return  new msg_array_test_0(this);
                        case msg_array_test_1.MAVLINK_MSG_ID_ARRAY_TEST_1:
                return  new msg_array_test_1(this);
                        case msg_array_test_3.MAVLINK_MSG_ID_ARRAY_TEST_3:
                return  new msg_array_test_3(this);
                        case msg_array_test_4.MAVLINK_MSG_ID_ARRAY_TEST_4:
                return  new msg_array_test_4(this);
                        case msg_array_test_5.MAVLINK_MSG_ID_ARRAY_TEST_5:
                return  new msg_array_test_5(this);
                        case msg_array_test_6.MAVLINK_MSG_ID_ARRAY_TEST_6:
                return  new msg_array_test_6(this);
                        case msg_array_test_7.MAVLINK_MSG_ID_ARRAY_TEST_7:
                return  new msg_array_test_7(this);
                        case msg_array_test_8.MAVLINK_MSG_ID_ARRAY_TEST_8:
                return  new msg_array_test_8(this);
                ...
                return  new msg_storm32_gimbal_manager_status(this);
                        case msg_storm32_gimbal_manager_control.MAVLINK_MSG_ID_STORM32_GIMBAL_MANAGER_CONTROL:
                return  new msg_storm32_gimbal_manager_control(this);
                        case msg_storm32_gimbal_manager_control_pitchyaw.MAVLINK_MSG_ID_STORM32_GIMBAL_MANAGER_CONTROL_PITCHYAW:
                ...
                return  new msg_avss_drone_position(this);
                        case msg_avss_drone_imu.MAVLINK_MSG_ID_AVSS_DRONE_IMU:
                return  new msg_avss_drone_imu(this);
                        case msg_avss_drone_operation_mode.MAVLINK_MSG_ID_AVSS_DRONE_OPERATION_MODE:
                return  new msg_avss_drone_operation_mode(this);
