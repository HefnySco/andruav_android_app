...
public class msg_gimbal_device_information extends MAVLinkMessage {
     ...
     */
    @Description("Extended bitmap of gimbal capability flags (32 bit). For backwards compatibility, the lower 16 bits should also be set in cap_flags. Ground stations should prefer this field if non-zero.")
    @Units("")
    public long cap_flags2;
    ...
    public MAVLinkPacket pack() {
        ...
        if (isMavlink2) {
             ...
             packet.payload.putUnsignedInt(cap_flags2);
    ...
    public void unpack(MAVLinkPayload payload) {
        ...
        if (isMavlink2) {
             ...
             this.cap_flags2 = payload.getUnsignedInt();
