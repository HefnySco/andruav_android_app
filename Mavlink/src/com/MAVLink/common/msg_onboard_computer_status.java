...
public class msg_onboard_computer_status extends MAVLinkMessage {
    ...
    public static final int MAVLINK_MSG_LENGTH = 240;
     ...
     */
    @Description("Bitmap of status flags.")
    @Units("")
     ...
     */
    public msg_onboard_computer_status( long time_usec, long uptime, long ram_usage, long ram_total, long[] storage_type, long[] storage_usage, long[] storage_total, long[] link_type, long[] link_tx_rate, long[] link_rx_rate, long[] link_tx_max, long[] link_rx_max, short[] fan_speed, short type, short[] cpu_cores, short[] cpu_combined, short[] gpu_cores, short[] gpu_combined, byte temperature_board, byte[] temperature_core, int status_flags) {
        this.msgid = MAVLINK_MSG_ID_ONBOARD_COMPUTER_STATUS;
     ...
     */
    public msg_onboard_computer_status( long time_usec, long uptime, long ram_usage, long ram_total, long[] storage_type, long[] storage_usage, long[] storage_total, long[] link_type, long[] link_tx_rate, long[] link_rx_rate, long[] link_tx_max, long[] link_rx_max, short[] fan_speed, short type, short[] cpu_cores, short[] cpu_combined, short[] gpu_cores, short[] gpu_combined, byte temperature_board, byte[] temperature_core, int status_flags, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_ONBOARD_COMPUTER_STATUS;
        this.sysid = sysid;
        this.compid = compid;
