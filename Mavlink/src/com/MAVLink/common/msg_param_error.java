 ...
 */
public class msg_param_error extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_PARAM_ERROR = 345;
    public static final int MAVLINK_MSG_LENGTH = 21;
    private static final long serialVersionUID = MAVLINK_MSG_ID_PARAM_ERROR;
    ...
    public MAVLinkPacket pack() {
        ...
        packet.msgid = MAVLINK_MSG_ID_PARAM_ERROR;
        ...
        packet.payload.putUnsignedByte(error);
    ...
    /**
     * Decode a param_error message into this class fields
     *
    ...
    public void unpack(MAVLinkPayload payload) {
        ...
        this.error = payload.getUnsignedByte();
     ...
     */
    public msg_param_error() {
        this.msgid = MAVLINK_MSG_ID_PARAM_ERROR;
    }

    /**
     * Constructor for a new message, initializes msgid and all payload variables
     */
    public msg_param_error( short param_index, short target_system, short target_component, byte[] param_id, short error) {
        this.msgid = MAVLINK_MSG_ID_PARAM_ERROR;
     ...
     */
    public msg_param_error( short param_index, short target_system, short target_component, byte[] param_id, short error, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_PARAM_ERROR;
        this.sysid = sysid;
        this.compid = compid;
     ...
     *
     */
    public msg_param_error(MAVLinkPacket mavLinkPacket) {
        this.msgid = MAVLINK_MSG_ID_PARAM_ERROR;
    ...
    */
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_PARAM_ERROR - sysid:"+sysid+" compid:"+compid+" param_index:"+param_index+" target_system:"+target_system+" target_component:"+target_component+" param_id:"+param_id+" error:"+error+"";
    }
    ...
    @Override
    public String name() {
        return "MAVLINK_MSG_ID_PARAM_ERROR";
    }
}
