...
public class msg_cubepilot_firmware_update_resp extends MAVLinkMessage {
    ...
    private static final long serialVersionUID = MAVLINK_MSG_ID_CUBEPILOT_FIRMWARE_UPDATE_RESP;
    ...
    public MAVLinkPacket pack() {
        ...
        packet.msgid = MAVLINK_MSG_ID_CUBEPILOT_FIRMWARE_UPDATE_RESP;
    ...
    /**
     * Decode a cubepilot_firmware_update_resp message into this class fields
     *
     ...
     */
    public msg_cubepilot_firmware_update_resp( long offset, short target_system, short target_component) {
        this.msgid = MAVLINK_MSG_ID_CUBEPILOT_FIRMWARE_UPDATE_RESP;
     ...
     */
    public msg_cubepilot_firmware_update_resp( long offset, short target_system, short target_component, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_CUBEPILOT_FIRMWARE_UPDATE_RESP;
        this.sysid = sysid;
        this.compid = compid;
