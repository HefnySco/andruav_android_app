...
public class CdcAcmSerialDriver extends CommonUsbSerialDriver {
    ...
    public static SparseArray<int[]> getSupportedDevices() {
        ...
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_ARDUPILOT_CHIBIOS2),
                new int[] {
                    UsbId.DEVICE_ARDUPILOT_CHIBIOS,
                    UsbId.DEVICE_ARDUPILOT_CHIBIOS2,
                });
        ...
        if (BuildConfig.DEBUG && !(supportedDevices.indexOfKey(Integer.valueOf(UsbId.VENDOR_ARDUPILOT_FUTURE)) < 0)) { throw new AssertionError(); }
        ...
        if (BuildConfig.DEBUG && !(supportedDevices.indexOfKey(Integer.valueOf(UsbId.VENDOR_CUBE_BOARD)) < 0)) { throw new AssertionError(); }
        ...
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_VRBrain_BOARD),
                new int[] {
                        UsbId.DEVICE_VRBrain_v51,
                        UsbId.DEVICE_VRBrain_v52,
                        UsbId.DEVICE_VRBrain_v54,
                        UsbId.DEVICE_VRCore_v10,
                        UsbId.DEVICE_VRUBrain_v51,
                });

        if (BuildConfig.DEBUG && !(supportedDevices.indexOfKey(Integer.valueOf(UsbId.VENDOR_Holybro_BOARD)) < 0)) { throw new AssertionError(); }
