...
public class SoloGoproStateV2 extends TLVPacket implements DroneAttribute {
     ...
     * Gopro capture mode.
     */
    private final byte captureMode;

    private final byte ntsc_pal;
    ...
    private final byte lowLight;

    private final byte photoResolution;

    private final byte photoBurstRate;

    /**
     * Requires compatible video settings
     */
    private final byte videoProtune;

    /**
     * Hero 3 only. Requires protune on
     */
    private final byte videoWhiteBalance;

    /**
     * Hero 3 only. Requires protune on
     */
    private final byte videoColor;

    /**
     * Hero 3 only. Requires protune on
     */
    private final byte videoGain;

    /**
     * Hero 3 only. Requires protune on
     */
    private final byte videoSharpness;

    /**
     * Requires protune on. Can be set on Hero4 but currently does not return correct setting.
     */
    private final byte videoExposure;

    private final byte gimbalEnabled;

    //EXTRA FIELDS
    private final byte extra1;
    private final byte extra2;
    private final byte extra3;
    private final byte extra4;
    private final byte extra5;
    private final byte extra6;
    private final byte extra7;

    private final short extra8;
    private final short extra9;
    private final short extra10;
    private final short extra11;
    private final short extra12;
