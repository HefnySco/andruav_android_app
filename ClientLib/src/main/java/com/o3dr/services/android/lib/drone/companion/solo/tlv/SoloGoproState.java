...
public class SoloGoproState extends TLVPacket implements DroneAttribute {
    ...
    private final byte whiteBalance;

    private final byte proTune;

    private final byte videoExposure;

    private final byte photoResolution;

    private final byte photoExposure;

    private final byte ntsc_pal;

    private final byte lowLight;

    private final byte spotMeter;

    private final byte batteryRemaining;

    private final byte photoRemaining;

    private final byte photoTaken;

    private final byte videoRemaining;

    private final byte videoTaken;

    private final byte color;

    private final byte sharpness;

    private final byte burstShutterRate;

    private final byte continuousShutterSpeed;

    private final byte timeLapseInterval;

    private final short extra1;

    private final short extra2;

    private final short extra3;

    private final short extra4;

    private final short extra5;
