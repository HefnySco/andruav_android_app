...
public class MavLinkCommands {
    ...
    public static final int MAVLINK_SET_POS_TYPE_MASK_VEL_Z_IGNORE         = (1 << 5);
    public static final int  MAVLINK_SET_POS_TYPE_MASK_FORCE               = (1<<9);
    public static final int  MAVLINK_SET_POS_TYPE_MASK_YAW_IGNORE          = (1<<10);
    public static final int  MAVLINK_SET_POS_TYPE_MASK_YAW_RATE_IGNORE     = (1<<11);
