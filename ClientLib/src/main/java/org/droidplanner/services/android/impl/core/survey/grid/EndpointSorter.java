...
public class EndpointSorter {
	...
	private final List<LatLong> gridPoints = new ArrayList<LatLong>();
	private final List<LineLatLong> grid;
	private final Double sampleDistance;
	private final List<LatLong> cameraLocations = new ArrayList<LatLong>();
