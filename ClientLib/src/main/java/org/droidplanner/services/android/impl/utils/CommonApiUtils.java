...
public class CommonApiUtils {
    ...
    public static void setGuidedVelocityInLocalFrame(final MavLinkDrone drone, final double xVel, final double yVel, final double zVel, double yawRate, final double yaw, final short coordinateFrame, final short typeMask, ICommandListener listener)
    {
        if (drone == null)
            return;

        drone.getGuidedPoint().newGuidedVelocityInLocalFrame(xVel, yVel, zVel, yawRate, yaw, coordinateFrame, typeMask);
    }

    public static void setGuidedVelocityInGlobalFrame(final MavLinkDrone drone, final double xVel, final double yVel, final double zVel, double yawRate, final double yaw, final short coordinateFrame, final short typeMask, ICommandListener listener)
    {
        if (drone == null)
            return;

        drone.getGuidedPoint().newGuidedVelocityInGlobalFrame(xVel, yVel, zVel, yawRate, yaw, coordinateFrame, typeMask);
    }

    public static void sendGuidedPoint(final MavLinkDrone drone, LatLong point, final boolean force, ICommandListener listener) {
        if (drone == null)
            return;
