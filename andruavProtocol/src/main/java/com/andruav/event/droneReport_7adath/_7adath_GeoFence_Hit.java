...
public class _7adath_GeoFence_Hit {
    ...
    public _7adath_GeoFence_Hit(final AndruavUnitBase andruavUnitBase, final String fenceName)
    {
        this.andruavUnitBase = andruavUnitBase;
        this.fenceName = fenceName;
    }

    public _7adath_GeoFence_Hit(AndruavUnitBase andruavUnitBase, String fenceName, boolean inZone, double distance, boolean shouldKeepOutside)
    {
        this.andruavUnitBase = andruavUnitBase;
        this.fenceName = fenceName;
        this.inZone = inZone;
