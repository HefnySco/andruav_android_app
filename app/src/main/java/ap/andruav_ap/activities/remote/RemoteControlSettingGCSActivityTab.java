...
public class RemoteControlSettingGCSActivityTab  extends AppCompatActivity implements ActionBar.TabListener, RemoteControlGamePadTestFragment.OnFragmentInteractionListener, RemoteModeFragment.OnFragmentInteractionListener,RemoteControlTestFragment.OnFragmentInteractionListener{
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(ap.andruavmiddlelibrary.R.string.title_activity_remote_control_setting_GCS_activity_tab_section1).toUpperCase(l);
                case 1:
                    return getString(ap.andruavmiddlelibrary.R.string.title_activity_remote_control_setting_GCS_activity_tab_section3).toUpperCase(l);
