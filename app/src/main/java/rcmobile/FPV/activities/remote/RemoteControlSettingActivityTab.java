...
public class RemoteControlSettingActivityTab extends AppCompatActivity implements ActionBar.TabListener, RemoteChannelsSettingFragment.OnFragmentInteractionListener, RemoteModeFragment.OnFragmentInteractionListener,RemoteControlTestFragment.OnFragmentInteractionListener, RemoteChannelsTrackingSettings.OnFragmentInteractionListener{
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    mFragment[position] =  RemoteChannelsSettingFragment.newInstance("1","1");
                    break;
                case 1:
                    mFragment[position] =  RemoteChannelsTrackingSettings.newInstance("1","1");
                    break;
                case 2:
                    mFragment[position] =  RemoteControlTestFragment.newInstance("1","1");
                    break;
                default:
