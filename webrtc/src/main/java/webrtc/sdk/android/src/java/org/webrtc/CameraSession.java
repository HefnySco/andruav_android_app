...
interface CameraSession {
  ...
  interface Events {
    ...
    void onCameraZoomChanged(CameraSession session, final float zoom);
    void onCameraFlashChanged(CameraSession session, final int flashOn);
  }
