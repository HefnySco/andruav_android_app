...
class Camera1Session implements CameraSession {
  ...
  public void setZoom (float zoom)
  {
    ...
    Camera.Parameters parameters = camera.getParameters();
    final int actual_zoom = (int) (parameters.getMaxZoom() * zoom);
    parameters.setZoom(actual_zoom);
    camera.setParameters(parameters);
  ...
  public void setFlash (final int flashOn)
  {
    try {
      ...
      Camera.Parameters parameters = camera.getParameters();
      String flashMode = flashOn == AndruavWebRTCGlobals.FlashOn ? Camera.Parameters.FLASH_MODE_TORCH : Camera.Parameters.FLASH_MODE_OFF;
